...
# randomFreeleech
Flight::route("POST /api/bonusPoints/badFolders", ["Gazelle\Api\BonusPoints", "randomFreeleech"]);
...
# glitchUsername
Flight::route("POST /api/bonusPoints/glitchUsername", ["Gazelle\Api\BonusPoints", "glitchUsername"]);
