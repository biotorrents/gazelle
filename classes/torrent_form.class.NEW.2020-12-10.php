...
class TorrentForm
{
    ...
    /**
     * Upload form meta function
     *
     * Easily configure the form order and logic.
     * All the functions it calls emit a basic form element.
     */
    public function upload_form_v2()
    {
        $ENV = ENV::go();

        if ($this->NewTorrent) {
            echo $this->uploadNotice();
            echo $this->announceSource();
...
HTML;
     ...
     * The Source is randomized to ensure unique info hashes.
     */
