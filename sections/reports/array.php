...
$Types = array(
		...
		"thread" => array(
			...
			"guidelines" => array(
				...
				<ul>
				<li>Reporting when <a href=\"rules.php?p=chat\">chat rules</a> have been broken, such as posts containing unnecessary flaming, useless posts, pictures of spiderman, or users just generally being pieces of shit.  We encourage all users to use this feature when they see a rules violation of any form.</li>
