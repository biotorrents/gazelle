...
$Types = array(
    ...
    "request" => array(
      "title" => "Request",
      "guidelines" => array(
        "The report request option is for reporting a request which breaks any of the rules found <a href=\"/rules/requests\">here</a> and for making minor, generally cosmetic, changes to a request (e.g. adding album art, revising a to-be-announced release title, etc.).",
        "We encourage all users to use this feature whenever possible. This will get quicker action than PMing a staff member will.",
    ...
    "thread" => array(
      ...
      "guidelines" => array(
        ...
        <ul>
        <li>Reporting when <a href=\"/rules/chat\">chat rules</a> have been broken, such as posts containing unnecessary flaming, useless posts, pictures of spiderman, or users just generally being pieces of shit.  We encourage all users to use this feature when they see a rules violation of any form.</li>
    ...
    "post" => array(
      "title" => "Forum Post",
      "guidelines" => array(
        "The report comment option is specifically for reporting when the <a href=\"/rules/chat\">chat rules</a> have been broken, such as posts containing unnecessary flaming, useless posts, pictures of spiderman, or users just generally being pieces of shit.",
    ...
    "collage" => array(
      "title" => "Collection",
      "guidelines" => array(
        "The report collection option is for reporting a collection which breaks one of the collection guidelines found on the <a href=\"/rules/collages\">collection rules page</a>.",
    ...
    "comment" => array(
      "title" => "Comment",
      "guidelines" => array(
        "The report comment option is specifically for reporting when the <a href=\"/rules/chat\">chat rules</a> have been broken, such as posts containing racism, offensive language, flaming, pornography, and other rules violations.",
        "We encourage all users to use this feature when they see a rules violation of any form.",
        "This will get quicker action than PMing a staff member will.",
        "Please restrict the use of this feature to reporting rules violations, and remember, this is for reporting comments, not replying to them."
      )
