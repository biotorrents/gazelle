          ...
          <tr id="misc" class="ftr_advanced<?=$HideAdvanced?>">
            ...
            <td class="nobr ft_misc">
              ...
              <select name="freetorrent" class="ft_freetorrent fti_advanced">
                ...
                <option value="2" <?Format::selected('freetorrent', 2)?>>Neutral
                  Leech</option>
                <option value="3" <?Format::selected('freetorrent', 3)?>>Either
                </option>
                <option value="0" <?Format::selected('freetorrent', 0)?>>Normal
                </option>
              </select>
  ...
  <tr class="colhead">
    ...
    <td class="sign snatches">
      <a href="<?=header_link('snatched')?>"
        ...
        <svg width="15" height="15" fill="black" class="tooltip" alt="Snatches" title="Snatches" viewBox="3 0 88 98">
