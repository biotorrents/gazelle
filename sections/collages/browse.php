...
?>
		<a href="collages.php?id=<?=$CollageID?>" class="brackets">Personal collection</a>
...
?>
		<br />
<?		} ?>
		<a href="collages.php?userid=<?=$LoggedUser['ID']?>" class="brackets">Collections you started</a>
		<a href="collages.php?userid=<?=$LoggedUser['ID']?>&amp;contrib=1" class="brackets">Collections you contributed to</a>
		<br /><br />
<?	} else { ?>
