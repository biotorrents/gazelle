      ...
      <h5 id="h2.2"><a href="#h2.2k"><strong>&uarr;</strong></a> <a href="#h2.2">2.2.</a> Duplicates &amp; Trumping</h5>
        <div class="box pad" style="padding: 10px 10px 10px 20px;">
          <ul>
            ...
            <li id="r2.2.5"><a href="#h2.2"><strong>&uarr;</strong></a> <a href="#r2.2.5">2.2.5.</a> <strong>Higher-resolution non-HD releases trump non-HD releases with lower-resolutions.</strong> If two torrents have the same encoding settings, language, and translation group, then the non-HD upload with the highest resolution maybe trump lower resolutions. The effectively means that only one non-HD release may exist for a given encode at any one time. All HD resolutions (720p, 1080p, 4k, etc.) may co-exist. Note: upscales are <strong>NOT</strong> allowed.</li>
