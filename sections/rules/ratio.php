...
?>
      ...
      <li>
        ...
        <div style="text-align: center;">
          <img style="vertical-align: middle;" class="tex_img"
            src="<?=\Gazelle\Image::process('https://chart.googleapis.com/chart?cht=tx&chf=bg,s,FFFFFF00&chl=%5Ctextrm%7B%28maximum+required+ratio%29+%2A+%281-%5Cfrac%7Bseeding%7D%7Bsnatched%7D%29%7D&ext=.png')?>"
    ...
    <ul>
      <li>
        ...
        Alice falls into the 60&ndash;80 GiB amount downloaded bracket in the table above.
      ...
      <li>
        ...
        multiply it by [1 &minus; (<var>seeding</var> / <var>snatched</var>)] (which is 0.50).
        Written out: <samp>0.40 * [1 &minus; (45 / 90)] = 0.20</samp>
      </li>
