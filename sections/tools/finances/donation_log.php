...
<div class="box pad">
  <img src="<?=$DonationTimeline?>"
    alt="Donation timeline. The &quot;y&quot; axis is donation amount." />
</div>
<br />
<?php
} */ ?>
  ...
  <form class="search_form" name="donation_log" action="" method="get">
    ...
    <table cellpadding="6" cellspacing="1" border="0" class="layout border" width="100%">
      <tr>
        ...
        <td>
          <input type="search" name="username" size="60" value="<?php if (!empty($_GET['username'])) {
    echo display_str($_GET['username']);
      ...
      <tr>
        ...
        <td>
          <input type="search" name="email" size="60" value="<?php if (!empty($_GET['email'])) {
    echo display_str($_GET['email']);
      ...
      <tr>
        ...
        <td>
          <input type="search" name="source" size="60" value="<?php if (!empty($_GET['source'])) {
...
<table width="100%">
  ...
  <tr>
    <td>
      <?=Users::format_username($Donation['UserID'], true)?>
      (<?=Users::format_username($Donation['AddedBy'])?>)
    </td>

    <td>
      <?=display_str($Donation['Amount'])?>
    </td>
