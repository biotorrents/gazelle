...
if (isset($_REQUEST['addtokens'])) {
  ...
  $message = '<strong>' . Text::number_format($Tokens) . 'freeleech tokens added to all enabled users' . (!isset($_REQUEST['leechdisabled']) ? ' with enabled leeching privs' : '') . '.</strong><br /><br />';
  ...
  View::header('Add tokens sitewide');
