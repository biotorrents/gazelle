...
function generate_user_table($Caption, $Tag, $Details, $Limit)
{
  ...
  if (empty($Details)) {
    ...
    <tr class="row">
      ...
      <td><?=User::format_username(intval($Detail['ID']), false, false, false)?>
      </td>
      ...
      <td class="number_column"><?=\Gazelle\Text::float($Detail['NumUploads'])?>
      </td>
