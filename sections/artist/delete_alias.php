...
$app->dbOld->query("
  ...
  WHERE aa.AliasID=$AliasID");
list($ArtistID, $ArtistName, $AliasName) = $app->dbOld->next_record(MYSQLI_NUM, false);
...
Misc::write_log("The alias $AliasID ($AliasName) was removed from the artist $ArtistID ($ArtistName) by user {$app->user->core['id']} ($app->user->core[username])");
