...
if ($_POST['submit'] == 'Delete') {
    ...
    WHERE id = '.$_POST['id']);
    \TrackerOld::update_tracker('remove_whitelist', array('peer_id' => $PeerID));
    ...
    if ($_POST['submit'] == 'Edit') { //Edit
        ...
        SET
          ...
          peer_id = '$PeerID'
        WHERE ID = ".$_POST['id']);
            \TrackerOld::update_tracker('edit_whitelist', array('old_peer_id' => $OldPeerID, 'new_peer_id' => $PeerID));
        }
    } else { //Create
        $app->dbOld->query("
      ...
      VALUES
        ('$Client', '$PeerID')");
        \TrackerOld::update_tracker('add_whitelist', array('peer_id' => $PeerID));
    }
}
