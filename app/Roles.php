...
class Roles extends ObjectCrud
{
    ...
    public array $permissions = [
        ...
        "admin" => [
            ...
            "freeleech" => "Can make torrents freeleech",
    ...
    public function can(array $permissions): bool
    {
        ...
        foreach ($permissions as $resource => $action) {
            ...
            if (!in_array($resource, array_keys($this->permissions))) {
                return false;
            }

            # invalid action given
            if (!in_array($action, array_keys($this->permissions[$resource]))) {
                return false;
            }
    ...
    {
        # no, these aren't in the database
     ...
     * getOldPermissions
     *
     * Lists the old site permissions.
     */
