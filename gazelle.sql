...
INSERT INTO stylesheets (ID, Name, Description, `Default`, Additions, Color) VALUES (1, 'Oppai', 'Oppaitime Stylesheet', '1', NULL, '#FBC2E5'), (2, 'Beluga', 'Beluga', '0', 'Pink|Haze', '#23252A'), (3, 'Genaviv', 'Genaviv Stylesheet', '0', 'Fixed Header', '#0A0A0A');
